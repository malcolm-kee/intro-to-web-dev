...
```htm
<p>
  HTML is easy! You can begin creating your own website as soon as you learn the
  basics.
</p>
...
```htm
There's a bunch of a tags flying around in
<a href="https://en.wikipedia.org/wiki/Pharmacology">Wikipedia</a>
```
...
<button onclick="alert('Oh God. The missile is launched.')">
  Launch Missile
</button>
```
...
<img
  src="https://i.kym-cdn.com/entries/icons/original/000/008/402/Screen_shot_2012-01-18_at_5.28.23_PM.png"
  alt="no copy-pasting face"
/>
