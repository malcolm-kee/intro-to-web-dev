---
title: Project - HTML, CSS, JS
path: '/html-css-js-project/'
description: ''
---
...
<iframe class="calc" width="300" height="475" title="Calculator" src="/calculator.html" frameborder="no" allowtransparency="true"></iframe>

This [Brian Holt][brian-holt]'s implementation (which I tweak the styles to make it slightly smaller) is embedded here on the page so feel free to play with it.
...
[mdn-margin-percentage]: https://developer.mozilla.org/en-US/docs/Web/CSS/margin#Values
